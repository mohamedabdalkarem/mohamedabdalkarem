...
.content { position: relative; z-index: 2; padding: 2.5rem 2.5rem 2rem; }
.eyebrow {
  font-family: 'JetBrains Mono', monospace; font-size: 11px; color: #378ADD;
...
.eyebrow::before { content: ''; width: 20px; height: 1px; background: #378ADD; }
.name {
  font-size: 42px; font-weight: 800; color: #f0f4ff;
...
.tagline-row {
  ...
  margin-bottom: 1.75rem; display: flex; align-items: center; gap: 6px;
  opacity: 0; animation: fadeUp 0.5s ease 0.3s forwards;
}
.cursor {
  display: inline-block; width: 8px; height: 14px; background: #5DCAA5;
...
.tag-blue  { background: rgba(55,138,221,0.15); color: #85B7EB; border: 0.5px solid rgba(55,138,221,0.35); }
.tag-green { background: rgba(29,158,117,0.15); color: #5DCAA5; border: 0.5px solid rgba(29,158,117,0.35); }
.tag-amber { background: rgba(186,117,23,0.15); color: #FAC775; border: 0.5px solid rgba(186,117,23,0.3); }
.stats-strip {
  position: relative; z-index: 2; display: flex;
  border-top: 0.5px solid rgba(55,138,221,0.15);
  opacity: 0; animation: fadeUp 0.5s ease 0.6s forwards;
}
.stat { flex: 1; padding: 0.9rem 1.5rem; }
.stat-val { font-family: 'Syne', sans-serif; font-weight: 700; font-size: 18px; color: #f0f4ff; line-height: 1; }
.stat-label {
  font-family: 'JetBrains Mono', monospace; font-size: 10px;
  color: rgba(176,196,230,0.5); margin-top: 3px; letter-spacing: 0.08em; text-transform: uppercase;
}
.divider {
...
<div class="hero-wrap">
  ...
  <div class="content">
    ...
    <div class="tagline-row">&gt;&nbsp;engineering data pipelines<span class="cursor"></span></div>
    <div class="tags-row">
